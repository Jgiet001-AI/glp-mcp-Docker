...
class InvokeDynamicTool(BaseTool):
    """Executes any workspaces API endpoint dynamically with schema validation."""
    ...
    def description(self) -> str:
        """Tool description."""
        return "Executes any workspaces API endpoint dynamically with parameter validation and schema support"
