...
"""
get_workspace_workspaces_v1_workspaces_workspaceid_get tool implementation for workspaces MCP server.

This tool Retrieve basic workspace information for a provided workspace identifier..
"""
...
class get_workspace_workspaces_v1_workspaces_workspaceid_getTool(BaseTool):
    """Retrieve basic workspace information for a provided workspace identifier."""

    @property
    def name(self) -> str:
        """Tool name."""
        return "get_workspace_workspaces_v1_workspaces_workspaceid_get"

    @property
    def description(self) -> str:
        """Tool description."""
        return "Retrieve basic workspace information for a provided workspace identifier."
    ...
    async def execute(self, arguments: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        Execute the get_workspace_workspaces_v1_workspaces_workspaceid_get tool.
