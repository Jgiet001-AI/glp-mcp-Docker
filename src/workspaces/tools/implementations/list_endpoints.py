...
"""
list_endpoints tool implementation for workspaces MCP server.
...
class ListEndpointsTool(BaseTool):
    ...
    def description(self) -> str:
        """Tool description."""
        return "Lists all available workspaces API endpoints as simple identifiers (method:path format) for fast discovery and selection"
