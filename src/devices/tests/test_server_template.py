...
"""
Tests for MCP server implementation of devices.
"""
...
class TestMCPServer:
    """Test cases for devices MCP server."""
    ...
    def mock_settings(self):
        ...
        settings.token_issuer = "https://devices.test.com/oauth2/token"
    ...
    def test_mcp_server_initialization(self, mcp_server):
        """Test MCP server initialization for devices."""
