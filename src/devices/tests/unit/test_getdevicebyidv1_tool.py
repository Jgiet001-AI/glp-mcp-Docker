...
"""
Test for getdevicebyidv1 tool in devices MCP server.

This file contains tests for the getdevicebyidv1 tool.
"""

import pytest

# Import getdevicebyidv1Tool
from tools.implementations.getdevicebyidv1 import getdevicebyidv1Tool


class Testgetdevicebyidv1Tool:
    """Test cases for getdevicebyidv1Tool."""

    @pytest.fixture
    def tool_instance(self, mock_http_client):
        """Create tool instance for testing."""
        return getdevicebyidv1Tool(mock_http_client)
    ...
    def test_tool_name(self, tool_instance):
        ...
        assert tool_instance.name == "getdevicebyidv1"
    ...
    async def test_execute_api_error(self, tool_instance, valid_arguments, mock_http_client):
        ...
        assert len(result) == 1
        assert result[0]["success"] is False
        assert result[0]["tool"] == "getdevicebyidv1"
