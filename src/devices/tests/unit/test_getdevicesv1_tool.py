...
"""
Test for getdevicesv1 tool in devices MCP server.

This file contains tests for the getdevicesv1 tool.
"""

import pytest

# Import getdevicesv1Tool
from tools.implementations.getdevicesv1 import getdevicesv1Tool


class Testgetdevicesv1Tool:
    """Test cases for getdevicesv1Tool."""

    @pytest.fixture
    def tool_instance(self, mock_http_client):
        """Create tool instance for testing."""
        return getdevicesv1Tool(mock_http_client)
    ...
    def test_tool_name(self, tool_instance):
        ...
        assert tool_instance.name == "getdevicesv1"
    ...
    async def test_execute_api_error(self, tool_instance, valid_arguments, mock_http_client):
        ...
        assert len(result) == 1
        assert result[0]["success"] is False
        assert result[0]["tool"] == "getdevicesv1"
