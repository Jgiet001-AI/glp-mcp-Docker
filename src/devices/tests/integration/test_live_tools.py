...
"""Live smoke tests for devices MCP tools.
...
TOOL_CASES = [
    {
        ...
        "parameters": [
            ...
            },
            {
                ...
                "required": False,
                "type": "str",
                "env": "MCP_TEST_DEVICES_FILTER_TAGS",
                "default": None,
            },
            {
                "name": "sort",
