...
"""
list_endpoints tool implementation for devices MCP server.
...
class ListEndpointsTool(BaseTool):
    ...
    def description(self) -> str:
        """Tool description."""
        return "Lists all available devices API endpoints as simple identifiers (method:path format) for fast discovery and selection"
