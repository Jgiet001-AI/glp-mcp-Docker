...
"""
invoke_dynamic_tool tool implementation for devices MCP server.
...
class InvokeDynamicTool(BaseTool):
    """Executes any devices API endpoint dynamically with schema validation."""
    ...
    def description(self) -> str:
        """Tool description."""
        return "Executes any devices API endpoint dynamically with parameter validation and schema support"
