...
"""
Test for getsubscriptiondetailsbyidv1 tool in subscriptions MCP server.

This file contains tests for the getsubscriptiondetailsbyidv1 tool.
"""

import pytest

# Import getsubscriptiondetailsbyidv1Tool
from tools.implementations.getsubscriptiondetailsbyidv1 import getsubscriptiondetailsbyidv1Tool


class Testgetsubscriptiondetailsbyidv1Tool:
    """Test cases for getsubscriptiondetailsbyidv1Tool."""

    @pytest.fixture
    def tool_instance(self, mock_http_client):
        """Create tool instance for testing."""
        return getsubscriptiondetailsbyidv1Tool(mock_http_client)
    ...
    def test_tool_name(self, tool_instance):
        ...
        assert tool_instance.name == "getsubscriptiondetailsbyidv1"
    ...
    async def test_execute_api_error(self, tool_instance, valid_arguments, mock_http_client):
        ...
        assert len(result) == 1
        assert result[0]["success"] is False
        assert result[0]["tool"] == "getsubscriptiondetailsbyidv1"
