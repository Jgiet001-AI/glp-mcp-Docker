...
"""
Tests for MCP server implementation of users.
"""
...
class TestMCPServer:
    """Test cases for users MCP server."""
    ...
    def mock_settings(self):
        ...
        settings.token_issuer = "https://users.test.com/oauth2/token"
    ...
    def test_mcp_server_initialization(self, mcp_server):
        """Test MCP server initialization for users."""
