...
class InvokeDynamicTool(BaseTool):
    """Executes any audit-logs API endpoint dynamically with schema validation."""
    ...
    def description(self) -> str:
        """Tool description."""
        return "Executes any audit-logs API endpoint dynamically with parameter validation and schema support"
