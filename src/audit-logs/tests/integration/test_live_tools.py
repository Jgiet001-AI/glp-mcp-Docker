...
"""Live smoke tests for audit-logs MCP tools.
...
from utils.http_client import AuditLogsHttpClient
        ...
        "parameters": [
            {
                ...
                "required": False,
                "type": "str",
                "env": "MCP_TEST_AUDIT_LOGS_FILTER",
                "default": None,
            },
            {
                "name": "select",
                "required": False,
                "type": "str",
                "env": "MCP_TEST_AUDIT_LOGS_SELECT",
                "default": None,
            },
            {
                "name": "all",
